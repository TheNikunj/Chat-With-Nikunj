        ...
        return (
            <div className="intern-image-bubble" onClick={() => setSelectedImage(imageUrl)}>
                <img 
                    ...
                    loading="lazy"
                />
                <span className="intern-message-time" style={{ color: 'rgba(255,255,255,0.8)', paddingRight: '4px', paddingBottom: '2px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                    {timeString}
    ...
    return (
        <div className={`intern-message-bubble ${msg.sender_id === user.id ? 'sent' : 'received'}`}>
            <div className="intern-bubble-content">
                ...
                <span className="intern-message-time flex items-center gap-1">
                    {timeString}
                    <MessageStatus status={msg.status} isOwnMessage={msg.sender_id === user.id} />
                </span>
            </div>
